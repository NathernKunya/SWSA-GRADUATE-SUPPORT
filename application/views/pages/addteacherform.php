  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row" >
        ...
        <div class="row">
          ...
          <input name="firstname" class="form-control" type="text" placeholder="First name" required>
				...
				<div class="form-group clearfix">
				  ...
				  <div class="col-sm-10">
          <input name="staffid" class="form-control" type="text" placeholder="Staff ID">
				  </div>
				</div>
				<div class="form-group clearfix">
				  <label for="example-url-input" class="col-sm-2 col-form-label">OFFICE</label>
				  <div class="col-sm-10">
          <input name="office" class="form-control" type="text" placeholder="Office">
				  </div>
				</div>
				<div class="form-group clearfix">
        ...
        <div class="form-group clearfix">
				  <label for="example-tel-input" class="col-sm-2 col-form-label">STAFF ROLE</label>
				  <div class="col-sm-10">
          <select name="role" class="form-control" type="text" required> 
        ...
        <div class="form-group clearfix">
				  <label for="example-number-input" class="col-sm-2 col-form-label">PHOTO</label>
				  <div class="col-sm-10">
        ...
        <div class="box-footer">
            ...
            <button type="submit" class="btn btn-info pull-left">SUBMIT DETAILS</button>
        </div>
        </div>
        </div>
        <!-- /.col -->
      ...
      <?php } ?>
        ...
        <?php if(isset($allteachers)){ ?>
            ...
            <th>ROLE</th>
                ...
                <?php 
                    ...
                    foreach($allteachers->result() as $row){
                     ...
                     ?>
					<tr>
            <td><img src="<?php echo ($row->photo)!=''?base_url($image):base_url($image2); ?>" alt="" srcset="" style="width:40px;height:40px;border-radius:30px;"></td>
            ...
            <td><?php echo ($row->role==NULL)?"N / A":$row->role; ?></td>
						<!-- <td>
            <?php if($row->Active=='1'){?>
              <button type="button" style="margin-right:10px;" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-deactivate<?php echo $row->id ?>">DE-ACTIVATE</button>
            <?php }else{ ?>
              <button type="button" style="margin-right:10px;" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal-role<?php echo $row->id ?>">ACTIVATE</button>
              <button type="button" style="margin-right:10px;" class="btn btn-info btn-xs pull-right" data-toggle="modal" data-target="#modal-info<?php echo $row->id ?>">EDIT </button>
            <?php } ?> -->
